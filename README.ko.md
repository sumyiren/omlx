...
[Releases](https://github.com/jundot/omlx/releases)에서 `.dmg`를 다운로드하고, Applications에 드래그하면 끝입니다. 앱 내 자동 업데이트를 지원하므로 이후 업그레이드는 클릭 한 번이면 됩니다.
...
mlx-lm의 BatchGenerator를 통해 동시 요청을 처리합니다. 프리필 및 완성 배치 크기를 설정할 수 있습니다.
...
관리자 패널에서 로드된 모델과 직접 채팅할 수 있는 기본적인 인터페이스를 제공합니다. 대화 기록, 모델 전환, 다크 모드, 추론 모델 출력을 지원합니다. (모델 테스트 목적의 채팅으로, 이미지 채팅과 첨부파일은 아직까지 지원하지 않습니다)

<p align="center">
  <img src="docs/images/Screenshot 2026-02-10 at 00.35.20.png" alt="oMLX 채팅" width="720">
</p>
